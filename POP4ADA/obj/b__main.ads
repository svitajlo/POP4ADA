...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_dinner_philosophers" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#18b764d2#;
   pragma Export (C, u00001, "dinner_philosophersB");
